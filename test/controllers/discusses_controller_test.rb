...
class DiscussesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discuss" do
    assert_difference("Discuss.count") do
      post discusses_url, params: { discuss: { comment: @discuss.comment, content: @discuss.content, id: @discuss.id, title: @discuss.title } }
    end
  ...
  test "should update discuss" do
    patch discuss_url(@discuss), params: { discuss: { comment: @discuss.comment, content: @discuss.content, id: @discuss.id, title: @discuss.title } }
