...
class PostLikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create post_like" do
    assert_difference("PostLike.count") do
      post post_likes_url, params: { post_like: { post_id: @post_like.post_id, post_like: @post_like.post_like, user_id: @post_like.user_id } }
    end
  ...
  test "should update post_like" do
    patch post_like_url(@post_like), params: { post_like: { post_id: @post_like.post_id, post_like: @post_like.post_like, user_id: @post_like.user_id } }
